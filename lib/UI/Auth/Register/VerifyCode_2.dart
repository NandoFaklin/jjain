...
import 'package:jhein_beta/UI/Auth/Register/VerifySucces_3.dart';
import 'package:otp_text_field/otp_field.dart';
import 'package:otp_text_field/otp_field_style.dart';
import 'package:otp_text_field/style.dart';

class VerifCodeRegister extends StatelessWidget {
  const VerifCodeRegister({super.key});
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: MaterialButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => VerifSuccessRegister(password: '1234'.toString(),),));
          },
          child: Text(
